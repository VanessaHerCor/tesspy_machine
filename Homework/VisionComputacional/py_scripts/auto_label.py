...
def auto_label_images():
    ...
    try:
        model = YOLO('../yolov8s-worldv2.pt')  # Modelo pequeño y eficiente (en raíz)
    ...
    for subset in subsets:
        ...
        if not os.path.exists(images_dir):
            ...
            print(f"   Primero ejecuta: python py_scripts/download_custom_images.py")
            continue
    ...
    print("2. Limpia imágenes sin detecciones: python py_scripts/clean_empty_labels.py")
    print("3. Entrena el modelo: python py_scripts/train_custom_model.py")
